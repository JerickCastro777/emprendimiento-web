...
import { fetchProductById, formatPrice } from "@/lib/products"; // <-- usamos solo fetchProductById
...
export default function ProductDetailPageClient() {
  ...
  // Estado: undefined = aún cargando, null = no encontrado, Product = cargado
  const [product, setProduct] = useState<Product | null | undefined>(undefined);
  const [loading, setLoading] = useState<boolean>(true);
  const [error, setError] = useState<string | null>(null);

  // UI states (mantengo los que tenías)
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        // fetchProductById es la función asíncrona correcta en tu lib
    ...
    // cargar cuando cambia el id o si aún no hay producto
    load();
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              {/* Botón único: cotización (sin <a> interno) */}
              <Link
